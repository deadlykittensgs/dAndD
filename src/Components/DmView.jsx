...
export default function DmView() {
  ...
  <DMPlayerCards name={"bob"} lvl={"0"} classType={"wizard"} hp={12} hpLeft={5} speed={35} ac={14} strTotal={"+1"} dexTotal={"+2"} conTotal={"-1"} intTotal={"-2"} wisTotal={"+3"} chaTotal={0} gold={30} orientation={"Neutral Good"} />
