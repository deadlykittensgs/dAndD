...
export default function Stats({roll, setRoll, toggle, race, setRace, setHpLeft, name, lvl, classType, hp, hpLeft,  speed,  ac, strTotal,  dexTotal, conTotal, intTotal, wisTotal, chaTotal, gold, playerName} ) {
    ...
    let HealthLeft = Number(hpLeft)
        ...
        if (num === "up"){
            setHpLeft( HealthLeft + 1);
           console.log(typeof(hpLeft))
        }
        if (num ==="down"){
            setHpLeft(HealthLeft - 1);
        }
      ...
      const lvlHelp = (type) => {
        ...
        try {
         ...
         console.log(error)
            ...
            //     window.open('https://www.dndbeyond.com/classes/9-barbarian', '_blank', 'noopener,noreferrer');
